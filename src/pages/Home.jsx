...
const Home = () => {
  ...
  return (
    <div className="home">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-indigo-900/95 via-blue-900/95 to-purple-900/95 backdrop-blur-md border-b border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="flex items-center justify-between h-16">
            {/* Logo and brand */}
            <div className="flex-shrink-0">
              <Link to="/" className="flex items-center space-x-2">
                <span className="text-2xl font-bold bg-gradient-to-r from-blue-200 to-indigo-200 text-transparent bg-clip-text hover:from-blue-100 hover:to-indigo-100 transition-all duration-300">BlogApp</span>
              </Link>
            </div>

            {/* Desktop Navigation */}
            <nav className="hidden md:flex items-center space-x-1">
              <Link to="/" className="text-gray-200 hover:text-white px-4 py-2 rounded-lg hover:bg-white/10 transition-all duration-300">Home</Link>
              <Link to="/write" className="text-gray-200 hover:text-white px-4 py-2 rounded-lg hover:bg-white/10 transition-all duration-300">Write</Link>
              <Link to="/about" className="text-gray-200 hover:text-white px-4 py-2 rounded-lg hover:bg-white/10 transition-all duration-300">About</Link>
              <Link to="/contact" className="text-gray-200 hover:text-white px-4 py-2 rounded-lg hover:bg-white/10 transition-all duration-300">Contact</Link>
            </nav>
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              <div className="relative">
                <input 
                  type="text" 
                  placeholder="Search..." 
                  className="w-48 bg-white/10 text-white placeholder-white/60 px-4 py-1.5 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-400/50 focus:bg-white/20 transition-all duration-300"
                />
                <FaSearch className="absolute right-3 top-1/2 transform -translate-y-1/2 text-white/60" />
              </div>

              {/* Auth Buttons */}
              <Link to="/login" className="bg-white/10 backdrop-blur-sm text-white px-5 py-1.5 rounded-full font-medium hover:bg-white/20 transition-all duration-300 border border-white/20">
                Login
              </Link>
              <Link to="/register" className="bg-blue-500 text-white px-5 py-1.5 rounded-full font-medium hover:bg-blue-600 transition-all duration-300 shadow-lg shadow-blue-500/25">
                Sign Up
              </Link>
            </div>
        ...
        {mobileMenuOpen && (
          <div className="absolute top-16 left-0 right-0 bg-gradient-to-b from-indigo-900/95 to-blue-900/95 backdrop-blur-md border-b border-white/10 shadow-xl">
            <nav className="max-w-7xl mx-auto px-4 py-4 flex flex-col space-y-2 animate-fadeIn">
              <Link to="/" className="text-gray-200 hover:text-white px-4 py-3 rounded-lg hover:bg-white/10 transition-all duration-300">Home</Link>
              <Link to="/write" className="text-gray-200 hover:text-white px-4 py-3 rounded-lg hover:bg-white/10 transition-all duration-300">Write</Link>
              <Link to="/about" className="text-gray-200 hover:text-white px-4 py-3 rounded-lg hover:bg-white/10 transition-all duration-300">About</Link>
              <Link to="/contact" className="text-gray-200 hover:text-white px-4 py-3 rounded-lg hover:bg-white/10 transition-all duration-300">Contact</Link>
              ...
              <div className="relative mt-2">
                <input 
                  type="text" 
                  placeholder="Search..." 
                  className="w-full bg-white/10 text-white placeholder-white/60 px-4 py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400/50 focus:bg-white/20 transition-all duration-300"
                />
                <FaSearch className="absolute right-3 top-1/2 transform -translate-y-1/2 text-white/60" />
              </div>
              ...
              <div className="flex flex-col space-y-2 pt-4 pb-2">
                <Link to="/login" className="bg-white/10 backdrop-blur-sm text-white px-5 py-3 rounded-lg font-medium hover:bg-white/20 transition-all duration-300 border border-white/20 text-center">
                  Login
                </Link>
                <Link to="/register" className="bg-blue-500 text-white px-5 py-3 rounded-lg font-medium hover:bg-blue-600 transition-all duration-300 shadow-lg shadow-blue-500/25 text-center">
                  Sign Up
                </Link>
              </div>
            </nav>
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-indigo-900 via-blue-900 to-purple-900 text-white pt-16">
